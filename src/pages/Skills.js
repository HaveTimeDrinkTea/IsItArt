      ...
      <Row>
        ...
        <Col size="sm-6">  
          <div className="rhsHome">
            <span className="opener"> <i className="fa fa-code" aria-hidden="true"></i> tech competencies <i className="fa fa-code" aria-hidden="true"></i> </span> <br/>
            ...
            <i className="fa-solid fa-database bgMySQL"></i> mySQL &amp; Oracle DBA <i className="fa-solid fa-cart-shopping bgWoo"></i> Woocommerce

            <br/><br/>
            <span className="opener"> <i className="fa fa-code" aria-hidden="true"></i> digital illustrations <i className="fa fa-code" aria-hidden="true"></i></span> <br/> I started digital illustrations during the pandemic and have been drawing on <strong><em>Procreate</em></strong> and <strong><em>Affinity Designer</em></strong> apps since. I am learning <strong><em>Affinity Photos</em></strong>  and <strong><em>Affinity Publisher</em></strong>. My art works are used mainly in the social media marketing for teanamu.com.
            <br/><br/>
            ...
            <br/><br/>
            <span className="opener"> <i className="fa fa-code" aria-hidden="true"></i> consultancy & data mining <i className="fa fa-code" aria-hidden="true"></i> </span> <br/> I worked with Oracle Singapore as a Oracle Financials consultant and later in data-mining and manager with a UK telecomms company and a large UK retailer.
            <br/><br/>
            <span className="opener"> <i className="fa fa-code" aria-hidden="true"></i> languages <i className="fa fa-code" aria-hidden="true"></i> </span> <br/> I am fluent in English and Chinese. I can also speak and read beginner's level Japanese (JLPT Level N4).
          </div>
        </Col>
